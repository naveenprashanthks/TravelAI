document.addEventListener('DOMContentLoaded', function() {
    ...
    // Function to update hotel booking link with destination
    function updateHotelLink(destination) {
        const hotelLinks = document.querySelectorAll('a[href*="book-hotels.html"]');
        hotelLinks.forEach(link => {
            link.href = `book-hotels.html?destination=${encodeURIComponent(destination)}`;
        });
    }
    ...
    function displayTravelPlan(travelPlan, destination, duration, travelers) {
        ...
        // Update hotel booking link with the selected destination
        updateHotelLink(destination);
